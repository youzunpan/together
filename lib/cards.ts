...
export const CARDS: Card[] = [
  ...
  { id: 5, limb: 'yama', theme: '非暴力', en: 'For a moment, stop blaming yourself.', zh: '先別責怪自己。' },
  ...
  { id: 48, limb: 'niyama', theme: '知足', en: 'Even a little goodness counts.', zh: '一點點好，也算。' },
  ...
  { id: 53, limb: 'niyama', theme: '自律', en: 'Slow is still moving forward.', zh: '慢一點，也還是在前進。' },
...
export const NIGHT_CARDS: Card[] = [
  ...
  { id: 40, limb: 'niyama', theme: '潔淨', en: 'What you no longer need can be left behind with this day.', zh: '不再需要的，可以留在這一天。' },
  ...
  { id: 77, limb: 'asana', theme: null, en: 'Come back to your body and let the looping thoughts fade.', zh: '回到身體，讓反覆回想慢慢停下來。' },
  ...
  { id: 91, limb: 'pratyahara', theme: null, en: 'The world can find you later.', zh: '世界晚一點再找到你。' },
