...
export const CARDS: Card[] = [
  ...
  { id: 8, limb: 'yama', theme: '非暴力', en: 'Real strength is soft.', zh: '真的強是軟的。' },
  // 真實
  { id: 9, limb: 'yama', theme: '真實', en: 'You knew already.', zh: '你早就知道了。' },
  { id: 10, limb: 'yama', theme: '真實', en: 'Feelings speak for themselves.', zh: '感覺自己會說話。' },
  { id: 11, limb: 'yama', theme: '真實', en: 'Say it and it lightens.', zh: '說出來就輕了。' },
  { id: 12, limb: 'yama', theme: '真實', en: 'Say it straight.', zh: '話直直地講。' },
  ...
  { id: 17, limb: 'yama', theme: '不偷盜', en: 'Bring your eyes back.', zh: '眼睛收回來。' },
  ...
  { id: 24, limb: 'yama', theme: '節制', en: 'Leave a gap in the day.', zh: '一天留點空。' },
  { id: 25, limb: 'yama', theme: '節制', en: 'Let that one pass.', zh: '讓那聲過去。' },
  ...
  { id: 28, limb: 'yama', theme: '節制', en: 'Spend your strength on what matters.', zh: '力氣留給重要的。' },
  // 不執取
  { id: 29, limb: 'yama', theme: '不執取', en: 'Loosen your hand.', zh: '手鬆一點。' },
  { id: 30, limb: 'yama', theme: '不執取', en: 'Keep what you want.', zh: '留下你要的。' },
  ...
  { id: 34, limb: 'yama', theme: '不執取', en: 'Let it handle itself.', zh: '交給它自己。' },
  { id: 35, limb: 'yama', theme: '不執取', en: 'If it goes, let it.', zh: '留不住就放。' },
  { id: 36, limb: 'yama', theme: '不執取', en: 'Letting go is also walking.', zh: '放下也是走。' },
  // ── 精進 Niyama ─
  // 潔淨
  { id: 37, limb: 'niyama', theme: '潔淨', en: 'Let the air in.', zh: '讓風進來。' },
  { id: 38, limb: 'niyama', theme: '潔淨', en: 'Let the old go.', zh: '舊的讓它走。' },
  ...
  { id: 46, limb: 'niyama', theme: '知足', en: 'What you have is enough.', zh: '你有的夠了。' },
  { id: 47, limb: 'niyama', theme: '知足', en: 'There\'s good in the ordinary.', zh: '平常裡有好東西。' },
  { id: 48, limb: 'niyama', theme: '知足', en: 'A little counts.', zh: '一點點也算。' },
  ...
  { id: 53, limb: 'niyama', theme: '自律', en: 'Slow is still walking.', zh: '慢也是走。' },
  { id: 54, limb: 'niyama', theme: '自律', en: 'Change can be quiet.', zh: '改變有時很安靜。' },
  { id: 55, limb: 'niyama', theme: '自律', en: 'Roots grow slowly.', zh: '根長得很慢。' },
  { id: 56, limb: 'niyama', theme: '自律', en: 'Start small.', zh: '小小地開始。' },
  { id: 57, limb: 'niyama', theme: '自律', en: 'The ache means change.', zh: '難受是要變了。' },
  // 自我研習
  ...
  { id: 60, limb: 'niyama', theme: '自我研習', en: 'Just watch it.', zh: '先看著就好。' },
  { id: 61, limb: 'niyama', theme: '自我研習', en: 'Repetition is the clue.', zh: '重複就是線索。' },
  { id: 62, limb: 'niyama', theme: '自我研習', en: 'You know yourself.', zh: '你懂自己的。' },
  ...
  { id: 67, limb: 'niyama', theme: '交託', en: 'You\'ll know on the way.', zh: '路上再知道。' },
  { id: 68, limb: 'niyama', theme: '交託', en: 'The road comes back.', zh: '路會再出現。' },
  { id: 69, limb: 'niyama', theme: '交託', en: 'Carry your own share.', zh: '揹你自己那份。' },
  { id: 70, limb: 'niyama', theme: '交託', en: 'The answer can wait.', zh: '答案晚點再說。' },
  { id: 71, limb: 'niyama', theme: '交託', en: 'You\'ve done enough.', zh: '你做的夠了。' },
  ...
  { id: 75, limb: 'asana', theme: null, en: 'The body knows first.', zh: '身體先知道。' },
  ...
  { id: 78, limb: 'asana', theme: null, en: 'Just stay.', zh: '先待著。' },
  ...
  { id: 83, limb: 'pranayama', theme: null, en: 'Come back on this breath.', zh: '跟這口氣回來。' },
  { id: 84, limb: 'pranayama', theme: null, en: 'The next breath comes by itself.', zh: '下一口自己會來。' },
  { id: 85, limb: 'pranayama', theme: null, en: 'There\'s space between breaths.', zh: '氣跟氣之間有空。' },
  { id: 86, limb: 'pranayama', theme: null, en: 'One breath after another.', zh: '一口接一口。' },
  // ── 制感 Pratyahara ─
  { id: 87, limb: 'pratyahara', theme: null, en: 'Let some of it pass.', zh: '有些話讓它過。' },
  { id: 88, limb: 'pratyahara', theme: null, en: 'Outside stays outside.', zh: '外面的留外面。' },
  { id: 89, limb: 'pratyahara', theme: null, en: 'Turn it down.', zh: '音量轉小。' },
  { id: 90, limb: 'pratyahara', theme: null, en: 'The world can wait.', zh: '世界可以等。' },
  { id: 91, limb: 'pratyahara', theme: null, en: 'It\'s still quiet in there.', zh: '裡面還安靜著。' },
  { id: 92, limb: 'pratyahara', theme: null, en: 'Pull your attention back.', zh: '注意力收回來。' },
  // ── 專注 Dharana ─
  { id: 93, limb: 'dharana', theme: null, en: 'One thing at a time.', zh: '一次一件事。' },
  { id: 94, limb: 'dharana', theme: null, en: 'Think of one thing.', zh: '想一件就好。' },
  { id: 95, limb: 'dharana', theme: null, en: 'When it wanders bring it back.', zh: '跑掉了就帶回來。' },
  { id: 96, limb: 'dharana', theme: null, en: 'Keep your eyes on what\'s here.', zh: '眼睛放在眼前。' },
  { id: 97, limb: 'dharana', theme: null, en: 'Coming back counts.', zh: '回來就算數。' },
  { id: 98, limb: 'dharana', theme: null, en: 'Mind what matters.', zh: '顧好重要的就好。' },
  // ── 禪那 Dhyana ─
  ...
  { id: 105, limb: 'samadhi', theme: null, en: 'Move toward what\'s happening.', zh: '靠近正在發生的。' },
  { id: 106, limb: 'samadhi', theme: null, en: 'Just feel it first.', zh: '先感覺就好。' },
  { id: 107, limb: 'samadhi', theme: null, en: 'Edges can soften.', zh: '邊界可以軟。' },
...
export const NIGHT_CARDS: Card[] = [
  ...
  { id: 2, limb: 'yama', theme: '非暴力', en: 'That took a lot to hold up.', zh: '撐得很辛苦吧。' },
  ...
  { id: 5, limb: 'yama', theme: '非暴力', en: 'You can set down what you carried.', zh: '揹來的可以放下。' },
  { id: 6, limb: 'yama', theme: '非暴力', en: 'You worked hard enough today.', zh: '今天夠努力了。' },
  ...
  { id: 14, limb: 'yama', theme: '真實', en: 'Seeing it is enough.', zh: '看清楚就好。' },
  { id: 15, limb: 'yama', theme: '真實', en: 'Let the feeling stay.', zh: '讓感覺待著。' },
  // 不偷盜
  { id: 16, limb: 'yama', theme: '不偷盜', en: 'Where did your attention go?', zh: '注意力去哪了？' },
  { id: 17, limb: 'yama', theme: '不偷盜', en: 'The comparing ends here.', zh: '比較到這裡就好。' },
  { id: 18, limb: 'yama', theme: '不偷盜', en: 'You have more than you remember.', zh: '你有的比記得的多。' },
  { id: 19, limb: 'yama', theme: '不偷盜', en: 'Who got your time?', zh: '時間都給誰了？' },
  { id: 20, limb: 'yama', theme: '不偷盜', en: 'What\'s theirs stays at the door.', zh: '他們的留在門外。' },
  ...
  { id: 24, limb: 'yama', theme: '節制', en: 'Save what\'s left for sleep.', zh: '剩的力氣留著睡。' },
  { id: 25, limb: 'yama', theme: '節制', en: 'Did you say yes too fast?', zh: '是不是答應太快了？' },
  { id: 26, limb: 'yama', theme: '節制', en: 'Less would have been lighter.', zh: '少做點就輕了。' },
  ...
  { id: 30, limb: 'yama', theme: '不執取', en: 'What if you left it?', zh: '放著會怎樣？' },
  { id: 31, limb: 'yama', theme: '不執取', en: 'It left. You\'re still here.', zh: '東西走了人還在。' },
  { id: 32, limb: 'yama', theme: '不執取', en: 'Leave the thought at the door.', zh: '念頭留在門口。' },
  { id: 33, limb: 'yama', theme: '不執取', en: 'Leave the unfinished here.', zh: '沒做完的留這裡。' },
  { id: 34, limb: 'yama', theme: '不執取', en: 'Loosen a little.', zh: '鬆開一點。' },
  { id: 35, limb: 'yama', theme: '不執取', en: 'Handle what you can handle.', zh: '管你管得動的。' },
  { id: 36, limb: 'yama', theme: '不執取', en: 'What\'s left after you let go?', zh: '放下後還剩什麼？' },
  // ── 精進 Niyama ─
  // 潔淨
  { id: 37, limb: 'niyama', theme: '潔淨', en: 'Noise stays at the door.', zh: '雜音留在門外。' },
  { id: 38, limb: 'niyama', theme: '潔淨', en: 'Wash a little of today off.', zh: '洗掉一點今天。' },
  { id: 39, limb: 'niyama', theme: '潔淨', en: 'What\'s taking up too much room?', zh: '什麼佔了太多位置？' },
  { id: 40, limb: 'niyama', theme: '潔淨', en: 'Leave the old with today.', zh: '舊的留給今天。' },
  ...
  { id: 44, limb: 'niyama', theme: '知足', en: 'Thank the ordinary too.', zh: '平常的也要謝。' },
  { id: 45, limb: 'niyama', theme: '知足', en: 'There was a moment you were full.', zh: '有一刻你是滿的。' },
  { id: 46, limb: 'niyama', theme: '知足', en: 'What was always there still is.', zh: '一直在的還在。' },
  { id: 47, limb: 'niyama', theme: '知足', en: 'Remember what today had.', zh: '記得今天有的。' },
  { id: 48, limb: 'niyama', theme: '知足', en: 'Today was whole.', zh: '今天是完整的。' },
  { id: 49, limb: 'niyama', theme: '知足', en: 'Today\'s is all here.', zh: '今天的都在這了。' },
  { id: 50, limb: 'niyama', theme: '知足', en: 'Take the good to sleep.', zh: '帶著好的去睡。' },
  // 自律
  { id: 51, limb: 'niyama', theme: '自律', en: 'You held on today.', zh: '你今天撐住了。' },
  { id: 52, limb: 'niyama', theme: '自律', en: 'It was hard and you got through.', zh: '辛苦但你過來了。' },
  ...
  { id: 63, limb: 'niyama', theme: '自我研習', en: 'Name it tomorrow.', zh: '名字明天再給。' },
  { id: 64, limb: 'niyama', theme: '自我研習', en: 'The answer arrives on its own.', zh: '答案會自己到。' },
  // 交託
  { id: 65, limb: 'niyama', theme: '交託', en: 'You did what you could.', zh: '能做的做了。' },
  ...
  { id: 72, limb: 'niyama', theme: '交託', en: 'Open your hand on the outcome.', zh: '手放開結果。' },
  // ── 體位 Asana ─
  ...
  { id: 77, limb: 'asana', theme: null, en: 'Back to the body and the circling stops.', zh: '回到身體念頭就停。' },
  { id: 78, limb: 'asana', theme: null, en: 'Let the weight reach the ground.', zh: '重量落到地上。' },
  ...
  { id: 81, limb: 'pranayama', theme: null, en: 'One breath brought you back.', zh: '有口氣把你帶回來。' },
  ...
  { id: 84, limb: 'pranayama', theme: null, en: 'Empty this breath out.', zh: '這口吐乾淨。' },
  { id: 85, limb: 'pranayama', theme: null, en: 'Let the breath close it.', zh: '呼吸收尾就好。' },
  { id: 86, limb: 'pranayama', theme: null, en: 'The next breath is enough.', zh: '下一口就夠了。' },
  // ── 制感 Pratyahara ─
  { id: 87, limb: 'pratyahara', theme: null, en: 'Which voice stayed too long?', zh: '哪個聲音跟太久了？' },
  { id: 88, limb: 'pratyahara', theme: null, en: 'Switch off today\'s voices.', zh: '今天的聲音關掉。' },
  { id: 89, limb: 'pratyahara', theme: null, en: 'Reply tomorrow.', zh: '話明天再回。' },
  { id: 90, limb: 'pratyahara', theme: null, en: 'Let the sound settle.', zh: '聲音沉下去。' },
  { id: 91, limb: 'pratyahara', theme: null, en: 'The world can find you later.', zh: '世界晚點再找你。' },
  { id: 92, limb: 'pratyahara', theme: null, en: 'Your mind is back.', zh: '心收回來了。' },
  // ── 專注 Dharana ─
  ...
  { id: 97, limb: 'dharana', theme: null, en: 'Coming back was enough.', zh: '回來過就好。' },
  ...
  { id: 106, limb: 'samadhi', theme: null, en: 'Some feelings are just that.', zh: '有些感覺就這樣。' },
