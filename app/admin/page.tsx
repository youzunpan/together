  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <Tabs defaultValue="applications">
        <TabsList className="w-full mb-6" style={{ background: "#5C677D", borderRadius: 0, padding: 0, gap: "1px" }}>
        ...
        <TabsContent value="members">
          <div className="space-y-px">
            ...
            {members?.map((m) => (
              <Link key={m.id} href={`/u/${m.id}`} style={{ background: "#5C677D", borderBottom: "1px solid rgba(255,255,255,0.04)", padding: "0.875rem 1rem", textDecoration: "none" }} className="flex items-center gap-3 hover:bg-[#2a2c28] transition-colors">
        ...
        <TabsContent value="sits">
          ...
          <div className="space-y-px mb-6">
            {daily.map(d => (
              <div key={d.date} style={{ background: "#5C677D", borderBottom: "1px solid rgba(255,255,255,0.04)", padding: "0.75rem 1rem" }}>
          ...
          <div className="space-y-px">
            {leaderboard.map((u, i) => (
              <Link key={u.user_id} href={`/u/${u.user_id}`} style={{ background: "#5C677D", borderBottom: "1px solid rgba(255,255,255,0.04)", padding: "0.75rem 1rem", textDecoration: "none" }} className="flex items-center gap-3 hover:bg-[#2a2c28] transition-colors">
