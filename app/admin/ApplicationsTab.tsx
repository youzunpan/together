...
export default function ApplicationsTab({ applications }: { applications: Application[] }) {
  ...
  return (
    <div>
      <div className="flex gap-1 mb-4" style={{ background: "#202220", padding: "2px" }}>
      ...
      <div className="space-y-px">
        {list.map(app => {
          ...
          return (
            <div key={app.id} style={{ background: "#202220", borderBottom: "1px solid rgba(255,255,255,0.04)", padding: "1rem" }}>
