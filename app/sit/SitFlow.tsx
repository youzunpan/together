...
export default function SitFlow() {
  ...
  if (step === "pick") {
    return (
      <div className="max-w-md mx-auto px-4 py-10">
        {earlyEnd && (
          <div className="fixed inset-0 flex items-center justify-center z-50" style={{ background: "#001233" }}>
        ...
        <div className="grid grid-cols-4 gap-1.5 mb-3">
          {PRESETS.map(m => (
            <button key={m} onClick={() => { setSelectedMin(m); setShowCustom(false); }}
              style={{
                ...
                background: (!showCustom && selectedMin === m) ? "#BEC23F" : "#5C677D",
                color: (!showCustom && selectedMin === m) ? "#001233" : "rgba(237,236,234,0.5)",
                border: "none",
                cursor: "pointer",
          ...
          <button onClick={() => setShowCustom(true)}
            style={{
              ...
              fontFamily: "var(--font-space-mono)",
              background: showCustom ? "#BEC23F" : "#5C677D",
              color: showCustom ? "#001233" : "rgba(237,236,234,0.3)",
  ...
  if (step === "timer") {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center" style={{ background: "#001233" }}>
