  ...
  return (
    <div className="max-w-md mx-auto px-4 py-6">
      ...
      <div className="grid grid-cols-2 gap-px mb-8" style={{ background: "rgba(255,255,255,0.04)" }}>
        <div style={{ background: "#001233", padding: "1.25rem 1rem" }}>
      ...
      <div className="space-y-px pb-8">
        {sits?.map((sit, i) => {
          ...
          return (
            <div key={i} id={isFirstOfDay ? `day-${dateKey}` : undefined} style={{ background: "#5C677D", borderBottom: "1px solid rgba(255,255,255,0.04)", padding: "0.75rem 1rem" }}>
