  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <p className="text-center mt-3" style={{ fontSize: "0.75rem", color: "rgba(237,236,234,0.3)", letterSpacing: "0.05em" }}>
          想了解課程？<a href="/courses" style={{ color: "#BEC23F", textDecoration: "underline", textUnderlineOffset: "3px" }}>看開放報名的課程</a>
        </p>
